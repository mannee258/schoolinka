...
class wplms_course_progress extends WP_Widget {
    ...
    if ( $title )
        ...
        $query = apply_filters('wplms_usermeta_direct_query',$wpdb->prepare("
        ...
        $results = $wpdb->get_results($query);
            ...
            if(empty($percentage)){
              $percentage = 0;
    				...
    				echo '<li>
                  <strong><a href="'.get_permalink($course_id).'">'.get_the_title($course_id).'</a><span>'.$percentage.'%</span></strong>
    							<div class="progress course_progress" data-course="'.$course_id.'">
