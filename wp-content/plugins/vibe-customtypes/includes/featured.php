    ...
    switch($featured_style){
           ...
           case 'course2':
            ...
            case 'course8' :
                ...
                if(!empty($featured)) {
                    $return .= '<span class = "featured_btn"><i class="fa fa-star-o"></i><small>'._x('Featured','','vibe-customtypes').'</small></span>';  
                }
                ...
                $return .= '<a href="'.get_permalink($custom_post->ID).'" class="more_btn">'._x('Course Info','','vibe-customtypes').'</a></div>';
                ...
                $return .= '<p class="course_price">'.bp_course_get_course_credits().'</p></div>';
                $return .=apply_filters('wplms_course_thumb_extras','');
                $return .= '</div></div>';
               ...
               $return ='';
                ...
                if($enable_instructor){
                    ...
                    if(!empty($instructors)){
                        ...
                        $displayname = bp_core_get_user_displayname( $instructor_id );
                        $instructor = '<a href="'.$author_domain.'" class="course_instructor" 
                                    title="'.sprintf(__('Course Author %s','vibe-customtypes'),$displayname).'"></a>';
                    }
                    $return .= $instructor;
                }
                $st = get_post_meta($custom_post->ID,'vibe_students',true);
           ...
           case 'side':
            ...
            case 'generic_card':
                ...
                $return .='<div class= "explore_more_btn"><a class= "button" href="'.get_permalink($custom_post->ID).'?action='.$course_id.'">'.__(' Explore More','vibe-customtypes').'</a></div>';
                $return .='</div>';
                $return .='</div>';
            break;
