 ...
 class Wplms_Vibe_Filterable extends \Elementor\Widget_Base  // We'll use this just to avoid function name conflicts 
{
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'exclude_terms',
			[
				'label' => __('Enter Taxonomy Term Slug To Exclude <br />(optional, only if above is selected, comma saperated for multiple terms): ', 'vibe-customtypes'),
				'type' => \Elementor\Controls_Manager::TEXT,
				'input_type' => 'text',
				'placeholder' => __( 'Enter Taxonomy Terms', 'vibe-customtypes' ),
			]
		);
