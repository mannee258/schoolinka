...
function register_required_plugins() {
    ...
    $plugins = array(
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/buddypress.4.1.0.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
            'version'               => '4.1.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/woocommerce.3.5.4.zip', // The plugin source
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/elementor.2.4.5.zip',
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
