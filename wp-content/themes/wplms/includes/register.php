    ...
    function wplms_enqueue_head() {
        ...
        if( ! is_admin() || $gutenberg ){
         ...
         if(!empty($google_fonts) && is_array($google_fonts)){
          ...
          if ( in_array( 'bbpress/bbpress.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) || (function_exists('vibe_check_plugin_installed') && vibe_check_plugin_installed( 'bbpress/bbpress.php'))){
