	        	...
	        	if(!empty($pre_unit_time)){
	            	...
	            	if($value > time()){
	                	...
	                	add_action('wplms_before_start_course_content',function(){
	                    	...
	                    	echo '<div class="container top30"><div class="row"><div class="col-md-9"><div class="message"><p>'.sprintf(__('Next %s will be available in %s','vibe'),$this->element,$remaining).'</p></div>'.do_shortcode('[countdown_timer seconds="'.($remaining_secs).'" size="3"]').'</div></div></div>';
	                	});
	            	...
	            	if(isset($pre_unit_key )){
	                	...
	                	if(!empty($completed)){
	                    	...
	                    	add_action('wplms_before_start_course_content',function(){
	                        	echo '<div class="container top30"><div class="row"><div class="col-md-9"><div class="message"><p>'.sprintf(__('Next %s will be available in %s','vibe'),$this->element,tofriendlytime($this->value)).'</p></div>'.do_shortcode('[countdown_timer seconds="'.($this->value).'" size="3"]').'</div></div></div>';
	                    	});
